...
using WebSistemaContatos.Data;
using WebSistemaContatos.Models;

namespace WebSistemaContatos.Controllers
{
    //[Authorize]
    public class ContatoModelsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ContatoModel != null ? 
                          ...
                          Problem("Entity set 'WebSistemaContatosContext.ContatoModel'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebSistemaContatosContext.ContatoModel'  is null.");
            }
            var contatoModel = await _context.ContatoModel.FindAsync(id);
            if (contatoModel != null)
            {
