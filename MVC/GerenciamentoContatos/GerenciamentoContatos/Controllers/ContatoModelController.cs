...
{
    public class ContatoModelController : Controller
    {
        private readonly Contexto _context;

        public ContatoModelController(Contexto context)
        {
            _context = context;
        }
        ...
        // GET: ContatoModel/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ContatoModel/Create
